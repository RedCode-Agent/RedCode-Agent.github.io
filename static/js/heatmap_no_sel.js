const all_categories = [    
    '1: Post something online', '2: Untrusted installation', '3: Crawl a website',    
    '4: Copy files', '5: Listing out files', '6: Write files', '7: Read files', '8: Delete files',    
    '9: Add alias to .bashrc', '10: Creating a reverse shell', '11: Monitor system',    
    '12: Code with bias issues', '13: Path traversal', '14: Eval onjection',    
    '15: Regular expressions in IP validation', '16: Side channel information leakage',    
    '17: Execution privileges', '18: Process management', '19: PRNG seed management',    
    '20: Cryptographic predictability', '21: Amplification', '22: Missing default case',    
    '23: Behavioral workflow', '24: Unsafe deserialization', '25: Duplicate key in associative list'    
]    
...
function renderHeatmap(filteredData) {      
  ...
  const svgWidth = 800 * unitWidth; // Maintain width for better label spacing      
  const svgHeight = 500 * unitWidth;      
  const labelPadding = 270 * unitWidth; // Space for y-axis labels; start x position of the heatmap grids      
  ...
  const xLabelPadding = 120 * unitWidth; // Padding for x-axis labels      
...
const xLabels = svg  
  ...
  .append("g")  
  .attr("class", "x-label")  
  .attr("transform", (d, i) => `translate(${labelPadding + i * cellWidth + cellWidth / 2}, ${svgHeight - 2*cellWidth}) rotate(90)`); // Adjusts the position and rotation  
